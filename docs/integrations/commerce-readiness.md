...
- Shipment persistence and packaging/address UI, CDEK courier pickup/refusal/returns, seller-arranged delivery and authenticated buyer receipt confirmation.
