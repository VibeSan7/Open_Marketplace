...
- Локальная commerce-основа сохраняет резервы, неизменяемые оплаченные снимки заказов, платёжный ledger и ожидающие планы физической отгрузки отдельно для каждого продавца. Запросов к платёжным и транспортным провайдерам она не делает.
