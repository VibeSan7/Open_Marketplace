...
**Актуальная версия с новым оформлением:** [скачать ZIP ветки main](https://github.com/VibeSan7/Open_Marketplace/archive/refs/heads/main.zip) · [Проверка интерфейса: 507 тестов и 120 браузерных проверок](docs/security/ui-presentation-local-validation.md)
